...
const SingleStrategy = ({ handleMessage }: SingleStrategyProps) => {
  return (
    <button
      className="cursor-pointer flex-1 bg-white border border-[rgba(95,121,241,0.4)] rounded-[11px] p-4 relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)] text-left flex flex-col gap-2"
