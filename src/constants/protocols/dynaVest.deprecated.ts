...
/**
 * @deprecated - MOVED TO COMING SOON
 * These contracts are deprecated and will be re-introduced when ready for production
 */

export const DEPRECATED_DYNAVEST_CONTRACTS = {
  [base.id]: {
...
// Note: These contracts will be re-enabled in a future release after security audit
